...
function makeClient (options) {
  ...
  return {
    ...
    getSignedUrl: getSignedUrl.bind(null, context)
  }
}
...
function getSignedUrl (context, operation, params, callback) {
  assert(params.Bucket, '"Bucket" property is required');
  assert(params.Key, '"Bucket" property is required');
  context.logger.info('creating signed url for', params.Bucket, params.Key);
    return util.optionalCallback(context, callback, util.signedRequest(context, {
  }));
}
